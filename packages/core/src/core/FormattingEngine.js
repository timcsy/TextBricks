...
class FormattingEngine {
     ...
     * 基本的程式碼片段格式化
     */
    formatCodeSnippetBasic(code, targetIndentation) {
     ...
     * 使用模板輔助的程式碼片段格式化
     */
    formatCodeSnippetWithTemplate(code, template, targetIndentation) {
     ...
     * 找到程式碼中的基準縮排層級
     */
    findBaseIndentLevel(indentInfo) {
